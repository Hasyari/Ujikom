			...
			<div class="container-fluid">
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="../assets/img/user.png" class="img-circle" alt="Avatar"> <span>Kasir</span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav" id="navButton">
						...
						<li><a href="index.php?page=transaksi" class=""><i class="lnr lnr-cog"></i> <span>Transaksi</span></a></li>
